...
trials = 1e3;   % Monte Carlo trials per n
...
% Plot
nvals = 2*(1:N);
figure('Name','100 Prisoners: simulation vs exact'); hold on; grid on; box on;
...
title('100 Prisoners: simulation vs exact');

% Results at n=100 (i=50)
fprintf('Check n=100: exact=%.6f, simulated≈%.6f, random choice=%.2e\n', ...
